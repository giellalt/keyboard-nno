# Keyboards for Norwegian Nynorsk
...
keyboards for the Norwegian Nynorsk language. The code
...
The Norwegian Nynorsk keyboard sources can be acquired using the Fork or Code
